      ...
      .ml-32.mr-36.lg_ml-36.lg_mr-40
        ...
        .mt-4.flex.flex-wrap.-ml-8.items-center
          ...
          template(v-if="record('twitter')")
            a.block.px-4.notouch_hover_text-greenbright-500.mt-8.-mb-12(:href="getENSSocialUrl(record('twitter'), 'https://twitter.com/')", target="_blank", rel="noopener noreferrer", title="Twitter")
              svg-twitter.block.h-28
          //- (github)
          template(v-if="record('github')")
            a.block.px-4.notouch_hover_text-greenbright-500.mt-8.-mb-12(:href="getENSSocialUrl(record('github'), 'https://github.com/')", target="_blank", rel="noopener noreferrer", title="GitHub")
              svg-github.block.h-28
          //- (discord)
          template(v-if="record('discord')")
            a.block.px-4.notouch_hover_text-greenbright-500.mt-8.-mb-12(:href="getENSSocialUrl(record('discord'), 'https://discord.com/')", target="_blank", rel="noopener noreferrer", title="Discord")
